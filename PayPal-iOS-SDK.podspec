...
Pod::Spec.new do |s|
  ...
  s.author             = { "HotelQuickly" => "admin@hotelquickly.com" }
  # s.authors          = { "HotelQuickly" => "admin@hotelquickly.com", "other author" => "email@address.com" }
  # s.author           = 'HotelQuickly', 'other author'
